...
function slider_background_callback( $post, $meta ) {
	...
	<div class="fields-list">
		<div class="field-wrap" style="width: 70%">
			<p class="label-wrapper"><label for="slide_video" style="display: block;"><b>Video background</b></label><em>Enter here link to video from Media Library or YouTube</em></p>
		...
		<div class="field-wrap" style="width: 30%">
			<p class="label-wrapper"><label for="video_aspect_ratio" style="display: block;"><b>Video aspect ratio</b></label></p>
			<?php
